...
params:
  repo_url: 'https://github.com/NewGraphEnvironment/safety_plan_fraser_2025'
  report_url: 'https://NewGraphEnvironment.github.io/safety_plan_raser_2025/'
...
hotel3 <- "170 7th Avenue, Burns Lake, BC, V0J 1E2"
...
hospital_name2 <- 'G.R. Baker Memorial Hospital'
hospital_phone2 <- '250-985-5600'
hospital_address2 <- '543 Front St, Quesnel, BC V2J 2K7'
...
Lucy Schick     
Vehicle:  `r vehicle2`  
Accommodations: `r hotel2`  
 `r hotel3`  


<br>

## Collaborating Crew Members {.unnumbered}
...
A summary of potential sites for fish passage assessments, habitat confirmation assessments, and electrofishing is provided in Table \@ref(tab:tab-electrofishing-sites) and Figure \@ref(fig:map-prep). Google Earth (KML) and Garmin (GPX) files for the proposed sites are available for download [here](`r knitr::asis_output(link_kml)`). 
...
Fieldwork methods will result in products feeding reporting formats such as our [2023/2024](https://www.newgraphenvironment.com/fish_passage_fraser_2023_reporting/) report. We generally follow procedures in:
